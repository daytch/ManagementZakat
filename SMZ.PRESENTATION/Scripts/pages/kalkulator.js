(function ($) {
    ...
    */
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.IsSuccess) {
                ...
                $('#harga_emas_niaga').val(convertToRupiah(response.Emas));
                $('#harga_emas_niaga').attr("disabled", true);
    ...
    nisab_emas_niaga = function () {
        ...
        harga = convertToAngka($('#harga_emas_niaga').val());
        harga = Number(harga);
        ...
        nisab = Number(nisab);
        $('#nisab_emas_niaga').val(convertToRupiah(nisab));
    }

    nisab_beras = function () {
        harga = convertToAngka($('#harga_beras').val());
        harga = Number(harga);
        ...
        nisab = Number(nisab);
        $('#nisab_beras').val(convertToRupiah(nisab));
    }
    ...
    zc_mal_total_pendapatan_jasa = function () {
        ...
        total_pendapatan_jasa = Number(total_pendapatan_jasa);
        $('#total_pendapatan_jasa').val(convertToRupiah(total_pendapatan_jasa));
    ...
    zc_pendapatan_jasa_hitung = function () {
        ...
        $('#zakat_pendapatan_jasa').val(convertToRupiah(zakat));
    }
    ...
    zc_dagang_total_harta = function () {
        ...
        $('#total_harta_dagang').val(convertToRupiah(total_harta_dagang));
    ...
    zc_dagang_total_kewajiban = function () {
        ...
        $('#total_kewajiban_dagang_float').val(Number(kewajiban));
        $('#total_kewajiban_dagang').val(convertToRupiah(kewajiban));

        zc_dagang_hitung();
    }

    zc_dagang_hitung = function () {
        nisab = $('#nisab_emas_niaga_float').val();
        ...
        $('#zakat_dagang').val(convertToRupiah(zakat));
    }
    ...
    zc_harta_temuan = function () {
        ...
        $('#zakat_temuan').val(convertToRupiah(zakat));
    }

    /* zakat ternak */
    zc_ternak_kambing = function () {
        kambing = $('#kambing').val();
        kambing = Number(kambing);
