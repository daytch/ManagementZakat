...
function add() {
    ...
    var tagInput = '<div class="row form-inline" id="' + (lastNumber + 1) + '">' +
        '<input type="text" class="col-xs-5" placeholder="Product" data-id="" id="Product' + (lastNumber + 1) + '"><input type="text" class="col-xs-2" placeholder="Harga" id="Price' + (lastNumber + 1) + '">' +
