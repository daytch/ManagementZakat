...
namespace TestDB
{
    ...
    public partial class job_workflow_history
    {
        public string id { get; set; }
        public string job_number { get; set; }
        public Nullable<int> seq { get; set; }
        public string current_status_id { get; set; }
        public Nullable<System.DateTime> current_status_created_date { get; set; }
        public string current_status_created_by { get; set; }
        public string last_status_id { get; set; }
        public Nullable<System.DateTime> last_status_created_date { get; set; }
